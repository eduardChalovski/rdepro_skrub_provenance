...
def run_pipeline(df_main, df_lookup, num_operations=1, verbose=False):
    ...
    return {
        ...
        # aggregation
        "mem_with_aggregation": 0,

        # tablevectorizer
        "mem_with_tablevectorizer": 0, #mem_with_tv,
...
def memory_benchmark_for_scaling_operations(
    ...
    if dataset_sizes is None:
        dataset_sizes = [1_000,10_000,100_000,1_000_000,10_000_000]
...
# python -m monkey_patching_v02.data_provenance.benchmark_memory_list_agg_merge